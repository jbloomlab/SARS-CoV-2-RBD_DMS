...
```{r calculate meanF, message=FALSE, warning=FALSE, error=FALSE}
...
counts_lib1[,c("ML_meanF","ML_sdF") := tryCatch(calc.MLmean(b1=lib1_SortSeq_bin1*20,
                                                            b2=lib1_SortSeq_bin2*20,
                                                            b3=lib1_SortSeq_bin3*20,
                                                            b4=lib1_SortSeq_bin4*20,
                                                            min.b1=log(20),
                                                            min.b2=log(1791.5),
                                                            min.b3=log(5845.5),
                                                            min.b4=log(16877.5),
...
counts_lib2[,c("ML_meanF","ML_sdF") := tryCatch(calc.MLmean(b1=lib2_SortSeq_bin1*20,
                                                            b2=lib2_SortSeq_bin2*20,
                                                            b3=lib2_SortSeq_bin3*20,
                                                            b4=lib2_SortSeq_bin4*20,
                                                            min.b1=log(20),
                                                            min.b2=log(1790.5),
                                                            min.b3=log(5401.5),
                                                            min.b4=log(15597.5),
...
```{r unfiltered expression distribution, echo=T, fig.width=13, fig.height=5, fig.align="center"}
...
```{r cell count coverage, echo=T, fig.width=13, fig.height=5, fig.align="center"}
#histograms
par(mfrow=c(1,2))
hist(log10(counts_lib1$total_count+0.1),xlab="cell count (log10, plus 0.1 pseudocount)",main="lib1")
hist(log10(counts_lib2$total_count+0.1),xlab="cell count (log10, plus 0.1 pseudocount)",main="lib2")
```
...
```{r estimate variance, fig.width=8, fig.height=8,fig.align="center"}
...
plot(x1_lib1,y1_lib1,xlab="number cells",ylab="variance in ML meanF measurement",main="lib1",pch=19,col="#92278F",ylim=c(0,1))
...
plot(x1_lib2,y1_lib2,xlab="number cells",ylab="variance in ML meanF measurement",main="lib2",pch=19,col="#92278F",ylim=c(0,1))
...
```{r apply variance and minimum coverage}
...
```{r filtered expression distribution, echo=T, fig.width=13, fig.height=5, fig.align="center"}
#histograms of lib1 and lib2, separating out by variant class and type
par(mfrow=c(1,2))
