...
We also read in all parameters from global epistasis models (ugly code hidden), and collapse down to individual tables reporting the lib1, lib2, and joint model inferred effects.
