...
```{r bc_tables, fig.width=6,fig.height=9,fig.align="center", dpi=300,dev="png"}
...
plot(bc_dt[!is.na(log10Ka) & log10Ka > 7,ML_meanF],bc_dt[!is.na(log10Ka) & log10Ka > 7,response],pch=16,col="#00000005",xlab="barcode expression (ML mean fluorescence)",ylab="barcode titration response parameter",main="all barcodes")
