...
```{r MSR_distribution, fig.width=6, fig.height=9, fig.align="center",dpi=300,dev="png",include=F}
# par(mfrow=c(3,2))
# hist(counts_lib1$MSR,main="lib1",xlab="Mean squared residual",col="gray50",breaks=40)
# hist(counts_lib2$MSR,main="lib2",xlab="Mean squared residual",col="gray50",breaks=30)
# 
# #As we would expect, the MSR stat decreases with cell count, indicating that higher cell counts leads to better curve fits
# plot(log10(counts_lib1$avgcount),counts_lib1$MSR,pch=19,col="#00000010",main="lib1",xlab="average cell count (log10)",ylab="MSR",xlim=c(0,5))
# plot(log10(counts_lib2$avgcount),counts_lib2$MSR,pch=19,col="#00000010",main="lib2",xlab="average cell count (log10)",ylab="MSR",xlim=c(0,5))
# 
...
# plot(log10(counts_lib1$Kd),counts_lib1$MSR,pch=19,col="#00000010",main="lib1",xlab="Kd",ylab="MSR")
# plot(log10(counts_lib2$Kd),counts_lib2$MSR,pch=19,col="#00000010",main="lib2",xlab="Kd",ylab="MSR")
```
