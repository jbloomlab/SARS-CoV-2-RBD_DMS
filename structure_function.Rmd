...
for(i in 1:nrow(dmsview_output_expr)){
  dmsview_output_expr$mut_relative_effect[i] <- 10^(dmsview_output_expr$mut_delta_effect[i])/10^(exp(dmsview_output_expr[label_site==dmsview_output_expr[i,label_site],mut_delta_effect]))
}
