...
For yeast display validation of beneficial mutation effects and expression/binding tradeoff, I would propose to validate the following seven mutations:

```{r yeast_display_validation_table, echo=FALSE}
kable(mutants[mutation %in% c("N439K","Q498Y","Q498H","N501D","N501T","N501F","G502D"),.(mutation,RBD_site,bind_lib1,bind_lib2,bind_avg,expr_lib1,expr_lib2,expr_avg,SARS1_indicator,RaTG13_indicator,GDPangolin_indicator)])
```
